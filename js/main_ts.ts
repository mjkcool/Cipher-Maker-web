...
const keysetBtn: HTMLElement|null = document.getElementById("key-btn") 
const encryption_btn: HTMLElement|null = document.getElementById("plain-txt-btn")
const decryption_btn: HTMLElement|null = document.getElementById("cipher-txt-btn")
const cipherResult = document.getElementById("result-cipher-txt") as HTMLInputElement
const plainResult  = document.getElementById("result-plain-txt") as HTMLInputElement
const plainInput = document.getElementById("plain-txt") as HTMLInputElement
const cipherInput = document.getElementById("cipher-txt") as HTMLInputElement
const clearBtn: HTMLElement|null = document.getElementById("clear")
const cipherCopyBtn: HTMLElement|null = document.getElementById("copy-cipher-btn")
const plainCopyBtn: HTMLElement|null = document.getElementById("copy-plain-btn")
const boardplace:any = document.querySelectorAll("td")


let keyboard:string[][] = new Array()[KBSIZE][KBSIZE] //암호판
let key: string, raw_key: string
...
function copy(type: number){
    
}

function removeDupplication(key: string){ //중복제거함수
    let newkey = ""
...
function encryption(){
    ...
    while(fair_i < plain.length){
        // var = [row, col]
        let left:any = getIndex(plain[fair_i])
        let right: any = getIndex(plain[fair_i + 1])
...
function processPlainTxt(text: string){
    let i
    let newstr = ''
